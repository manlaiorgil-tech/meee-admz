...
const ShuffleIcon = ({ active }) => (
  <svg className={`h-4 w-4 ${active ? 'text-white' : 'text-neutral-500'}`} fill="currentColor" viewBox="0 0 24 24">
...
const HeartIcon = ({ filled }) => (
  <svg
    className={`h-4 w-4 ${filled ? 'text-white fill-white' : 'text-neutral-500'}`}
    ...
    >
      <div className="rounded-2xl bg-gradient-to-b from-[#282828] to-[#121212] p-6 shadow-2xl">
        ...
        <div className="mb-4">
          ...
          >
            <div
              className="absolute left-0 top-0 h-full rounded-full bg-white group-hover:bg-neutral-300 transition-colors"
        ...
        <div className="flex items-center justify-center gap-6">
          <button onClick={() => setShuffle(!shuffle)} className="transition-transform hover:scale-110">
          ...
          <button onClick={() => setRepeat(!repeat)} className="transition-transform hover:scale-110">
        ...
        <div className="mt-6 flex items-center gap-3">
          ...
          <div className="relative flex-1">
            <input
              ...
              className="player-volume-slider w-full h-1 rounded-full appearance-none cursor-pointer"
              style={{
